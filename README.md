...
[![test status](https://github.com/simpleframeworks/LogC/actions/workflows/test.yml/badge.svg?branch=master "test status")](https://github.com/simpleframeworks/LogC/actions)
